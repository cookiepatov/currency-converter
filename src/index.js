...
function init()
{
  ...
  getUserInfo().then(userCurrency=>{
    ...
    btnFrom.innerHTML=` <img src="src/country-icons/${getIconById(currentData, currencyFrom)}" class="converter__button-img" alt="Иконка валюты">
    ${currencyFrom}`;
    btnTo.innerHTML=` <img src="src/country-icons/${getIconById(currentData, currencyTo)}" class="converter__button-img" alt="Иконка валюты">
    ${currencyTo}`;
  })
  updateCurrentRate();
  getUserInfo();
...
function setCurrency(currency) {
  ...
  {
    btnFrom.innerHTML=` <img src="src/country-icons/${getIconById(currentData, currency)}" class="converter__button-img" alt="Иконка валюты">
    ${currency}`;
  ...
  else
  {
    ...
    btnTo.innerHTML=` <img src="src/country-icons/${getIconById(currentData, currency)}" class="converter__button-img" alt="Иконка валюты">
    ${currency}`;
    currencyTo = currency;
  }
  updateCurrentRate();
